...
if(isset($_POST['girisformu'])){
	...
	if(!$email || !$sifre) {
		?>
		<script> 
		alert('E-mail ve şifre alanını doldurulması gerekiyor.')
		window.location.href='index.php';
		</script>
		<?php
	} else {
		$kontrol = $conn -> prepare( 'SELECT * FROM kullanicilar WHERE email= :email and sifre = :sifre');
		$kontrol -> execute (array(':email' => $email, ':sifre' => $sifre));
...
<body>
	...
	<div class="sin-w3-agile">
		...
		<form action="#" method="post">
			<div class="username">
				<span class="username">E-mail Adresi:</span>
